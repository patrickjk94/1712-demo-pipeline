...
@WebServlet("/ajaxAllPending")
public class AjaxAllPendingReimbursementsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
   
/**
 * @see HttpServlet#HttpServlet()
 */
public AjaxAllPendingReimbursementsServlet() {
    super();
}
...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {		
		...
		if(sessionUser != null) {
			...
			ArrayList<Reimbursement> reimbursements = service.getAllPendingReimbursements(); 
